...
## **[执行 Workflow](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#Execute-Workflow)**
...
```
curl -X POST 'https://ai.trendpower.cc/v1/workflows/run' \
...
当执行因 Human-in-the-Loop 暂停时，响应仍然会包含 `workflow_run_id` 和 `task_id`，但 `data.status` 会变为 `paused`。 暂停响应还会包含 `paused_nodes` 和 `reasons`。对于 `human_input_required`，每个 reason 都会包含 `form_id` 和 `expiration_time`。
...
## **[执行指定版本 Workflow](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#Execute-Specific-Workflow)**
...
```
curl -X POST 'https://ai.trendpower.cc/v1/workflows/{workflow_id}/run' \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "inputs": {},
...
## **[获取 Workflow 执行情况](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#get-workflow-run-detail)**
...
```
curl -X GET 'https://ai.trendpower.cc/v1/workflows/run/:workflow_run_id' \
...
## **[停止响应](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#stop-generatebacks)**
...
```
curl -X POST 'https://ai.trendpower.cc/v1/workflows/tasks/:task_id/stop' \
-H 'Authorization: Bearer {api_key}' \
-H 'Content-Type: application/json' \
...
## **[获取人工输入表单](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#get-human-input-form)**
...
## **[提交人工输入表单](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#submit-human-input-form)**
...
## **[获取恢复后的 Workflow 事件流](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#get-workflow-resume-events)**
...
## **[上传文件](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#files-upload)**
...
## **[获取终端用户](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#end-user)**
...
## **[获取 Workflow 日志](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#Get-Workflow-Logs)**
...
- Name
  ...
  [由哪个邮箱账户创建，例如，lizb@test.com](mailto:由哪个邮箱账户创建，例如，lizb@test.com).
...
```
curl -X GET 'https://ai.trendpower.cc/v1/workflows/logs'\
--header 'Authorization: Bearer {api_key}'
```
...
## **[获取应用基本信息](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#info)**
...
## **[获取应用参数](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#parameters)**
...
## **[获取应用 WebApp 设置](http://ai.trendpower.cc/app/303cf710-4684-4462-9010-945a8fc3a1f3/develop#site)**
